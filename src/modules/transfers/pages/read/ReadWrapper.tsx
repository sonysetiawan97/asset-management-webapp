...
import { moduleName, type ReadTransferModel } from "../../types/Model";
...
const ReadPage: FC = () => {
  ...
  if (!assetsData || !locationsData || !usersData) return <LoadingPage />;
  return (
...
const ReadWrapper: FC = () => {
  ...
  const methods = useForm<ReadTransferModel>({ mode: "onBlur" });
  const { reset } = methods;
