  ...
  return (
    <FormProvider {...methods}>
      <TitleBarWithIcon title={t("modules.checkout.read.title")}>
        <svg className="d-flex" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 -960 960 960" width="18px" fill="#373737"><path d="M480-312q70 0 119-49t49-119q0-70-49-119t-119-49q-70 0-119 49t-49 119q0 70 49 119t119 49Zm0-72q-40 0-68-28t-28-68q0-40 28-68t68-28q40 0 68 28t28 68q0 40-28 68t-68 28Z" /></svg>
      </TitleBarWithIcon>
      <ReadPage />
    </FormProvider>
  );
